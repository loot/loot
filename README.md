...
You may also need to set `BOOST_ROOT` if CMake cannot find Boost, and include Qt's `cmake` directory (e.g. `C:/Qt/6.2.2/msvc2019_64`) in `CMAKE_PREFIX_PATH` if CMake cannot find Qt.
