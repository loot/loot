...
cmake -B build . -DCMAKE_BUILD_TYPE=RelWithDebInfo \
    ...
    -DCMAKE_PREFIX_PATH=/opt/qt/6.11.0/mingw_64 \
...
You may also need to set `BOOST_ROOT` if CMake cannot find Boost, and `Qt6_ROOT` (e.g. to `C:/Qt/6.11.0/msvc2022_64`) if CMake cannot find Qt.
