...
namespace loot {
    ...
    void WriteMessage(pugi::xml_node& listItem, unsigned int type, std::string content) {
    ...
    bool AppendDetails(pugi::xml_node& main, const std::list<Plugin>& plugins, int& messageNo, int& warnNo, int& errorNo, const std::string& oldDetails) {
    ...
    void GenerateReport(const boost::filesystem::path& file,
        ...
        std::string oldDetails = GetOldReportDetails(file);
