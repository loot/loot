    ...
    private:
        ...
        void CheckFile(bool& result, const std::string& file) const {
            ...
            if (!IsSafePath(file)) {
                ...
                throw loot::Error(loot::Error::Code::invalid_args, boost::locale::translate("Invalid file path:").str() + " " + file);
            }
        ...
        std::pair<boost::filesystem::path, std::regex> SplitRegex(const std::string& regex) const {
            ...
            try {
                ...
                throw loot::Error(loot::Error::Code::invalid_args, (boost::format(boost::locale::translate("Invalid regex string \"%1%\": %2%")) % regex % e.what()).str());
            }
            ...
            if (!IsSafePath(parent)) {
                ...
                throw loot::Error(loot::Error::Code::invalid_args, boost::locale::translate("Invalid folder path:").str() + " " + parent.string());
            }
            ...
            try {
                ...
                throw loot::Error(loot::Error::Code::invalid_args, (boost::format(boost::locale::translate("Invalid regex string \"%1%\": %2%")) % filename % e.what()).str());
            }
        ...
        void SyntaxError(Iterator const& /*first*/, Iterator const& last, Iterator const& errorpos, boost::spirit::info const& what) {
            ...
            throw loot::Error(loot::Error::Code::condition_eval_fail, (boost::format(boost::locale::translate("Expected \"%1%\" at \"%2%\".")) % what.tag % context).str());
        }
