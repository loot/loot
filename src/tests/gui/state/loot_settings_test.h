...
TEST_F(LootSettingsTest, defaultConstructorShouldSetDefaultValues) {
  ...
  EXPECT_EQ(LootSettings::Language({"ta", "தமிழ்"}), actualLanguages[16]);
  EXPECT_EQ(LootSettings::Language({"tr_TR", "Türkçe"}), actualLanguages[17]);
  EXPECT_EQ(LootSettings::Language({"uk_UA", "Українська"}),
            actualLanguages[18]);
  EXPECT_EQ(LootSettings::Language({"zh_CN", "简体中文"}), actualLanguages[19]);
}
...
TEST_F(LootSettingsTest, loadingShouldMapGameIds) {
  ...
  EXPECT_EQ(GameId::tes3, settings_.getGameSettings()[0].getId());
  EXPECT_EQ(GameId::tes4, settings_.getGameSettings()[1].getId());
  EXPECT_EQ(GameId::nehrim, settings_.getGameSettings()[2].getId());
  EXPECT_EQ(GameId::tes5, settings_.getGameSettings()[3].getId());
  EXPECT_EQ(GameId::enderal, settings_.getGameSettings()[4].getId());
  EXPECT_EQ(GameId::tes5se, settings_.getGameSettings()[5].getId());
  EXPECT_EQ(GameId::enderalse, settings_.getGameSettings()[6].getId());
  EXPECT_EQ(GameId::tes5vr, settings_.getGameSettings()[7].getId());
  EXPECT_EQ(GameId::fo3, settings_.getGameSettings()[8].getId());
  EXPECT_EQ(GameId::fonv, settings_.getGameSettings()[9].getId());
  EXPECT_EQ(GameId::fo4, settings_.getGameSettings()[10].getId());
...
TEST_F(LootSettingsTest, loadingShouldMapFromTypeIfGameIdIsNotPresent) {
  ...
  EXPECT_EQ(GameId::tes3, settings_.getGameSettings()[0].getId());
  EXPECT_EQ(GameId::tes4, settings_.getGameSettings()[1].getId());
  EXPECT_EQ(GameId::tes5, settings_.getGameSettings()[2].getId());
  EXPECT_EQ(GameId::tes5se, settings_.getGameSettings()[3].getId());
  EXPECT_EQ(GameId::tes5vr, settings_.getGameSettings()[4].getId());
  EXPECT_EQ(GameId::fo3, settings_.getGameSettings()[5].getId());
  EXPECT_EQ(GameId::fonv, settings_.getGameSettings()[6].getId());
  EXPECT_EQ(GameId::fo4, settings_.getGameSettings()[7].getId());
  EXPECT_EQ(GameId::fo4vr, settings_.getGameSettings()[8].getId());
}
...
TEST_F(LootSettingsTest,
  ...
  EXPECT_EQ(GameId::tes5se, settings_.getGameSettings()[0].getId());
}
...
TEST_F(LootSettingsTest,
  ...
  ASSERT_EQ(1, settings_.getGameSettings().size());
  EXPECT_EQ(GameId::nehrim, settings_.getGameSettings()[0].getId());
}
...
TEST_F(LootSettingsTest,
  ...
  ASSERT_EQ(1, settings_.getGameSettings().size());
  EXPECT_EQ(GameId::enderal, settings_.getGameSettings()[0].getId());
}
...
TEST_F(LootSettingsTest,
  ...
  EXPECT_EQ(GameId::enderalse, settings_.getGameSettings()[0].getId());
  EXPECT_EQ(GameId::enderalse, settings_.getGameSettings()[1].getId());
}
...
TEST_F(LootSettingsTest, loadingShouldSetGameMinimumHeaderVersion) {
  ...
  ASSERT_EQ(1, settings_.getGameSettings().size());
  EXPECT_EQ("Game Name", settings_.getGameSettings()[0].getName());
  EXPECT_EQ(1.0, settings_.getGameSettings()[0].getMinimumHeaderVersion());
}
...
TEST_F(LootSettingsTest, loadingShouldHandleNonAsciiPathsInGameSettings) {
  ...
  ASSERT_EQ(1, settings_.getGameSettings().size());
  EXPECT_EQ("Oblivion", settings_.getGameSettings()[0].getFolderName());
  EXPECT_EQ(u8"non\u00C1sciiGamePath",
            settings_.getGameSettings()[0].getGamePath().u8string());
  EXPECT_EQ(u8"non\u00C1sciiGameLocalPath",
            settings_.getGameSettings()[0].getGameLocalPath().u8string());
}
...
TEST_F(LootSettingsTest, loadingShouldHandleNonAsciiStringInLocalFolder) {
  ...
  EXPECT_EQ(getLocalAppDataPath() /
            ...
            settings_.getGameSettings()[0].getGameLocalPath());
}
...
TEST_F(LootSettingsTest, loadingShouldReadHiddenMessagesForTheParentGame) {
  ...
  const auto& messages = settings_.getGameSettings().at(0).getHiddenMessages();
...
TEST_F(LootSettingsTest, loadingTomlShouldUseGivenFolderWhenTypeIsNotPresent) {
  ...
  EXPECT_EQ(GameId::tes5se, settings_.getGameSettings()[0].getId());
  EXPECT_EQ("SkyrimSE", settings_.getGameSettings()[0].getFolderName());
}
...
TEST_F(LootSettingsTest, loadingTomlShouldUpgradeOldSkyrimSEFolderAndType) {
  ...
  EXPECT_EQ("Skyrim Special Edition",
            settings_.getGameSettings()[0].getFolderName());
}
...
TEST_F(LootSettingsTest, storeGameSettingsShouldReplaceExistingGameSettings) {
  ...
  ASSERT_EQ(1, settings_.getGameSettings().size());
  EXPECT_EQ(GameId::tes5, settings_.getGameSettings()[0].getId());
}
