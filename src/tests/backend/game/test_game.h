...
namespace loot {
    namespace test {
        ...
        TEST_F(GameTest, Constructors) {
            ...
            game = Game(Game::tes5);
            settings = GameSettings(GameSettings::tes5);

            EXPECT_EQ(Game::tes5, game.Id());
            EXPECT_EQ(settings.Name(), game.Name());
            EXPECT_EQ(settings.FolderName(), game.FolderName());
            EXPECT_EQ(settings.Master(), game.Master());
            EXPECT_EQ(settings.RegistryKey(), game.RegistryKey());
            ...
            game = Game(Game::tes5, "folder");
            settings = GameSettings(GameSettings::tes5, "folder");
    ...
    // won't get auto-detected. Test for failure on Linux though.
            ...
            game = Game(Game::tes5).SetGamePath(dataPath.parent_path());
        ...
        TEST_F(GameTest, LoadPlugins) {
            ...
            Plugin plugin = game.GetPlugin("Skyrim.esm");
        ...
        TEST_F(GameTest, LoadPlugins_HeadersOnly) {
            Game game(Game::tes5);
            game.SetGamePath(dataPath.parent_path());
        ...
        TEST_F(GameTest, ArePluginsFullyLoaded) {
            Game game(Game::tes5);
            game.SetGamePath(dataPath.parent_path());
            EXPECT_FALSE(game.ArePluginsFullyLoaded());
        ...
        TEST_F(GameTest, shouldThrowIfCheckingIfPluginThatIsntLoadedIsActiveAndGameHasNotBeenInitialised) {
            Game game(Game::tes5);
            game.SetGamePath(dataPath.parent_path());
        ...
        TEST_F(GameTest, shouldShowBlankEsmAsActiveIfItHasNotBeenLoadedAndTheGameHasBeenInitialised) {
            Game game(Game::tes5);
            game.SetGamePath(dataPath.parent_path());
        ...
        TEST_F(GameTest, shouldShowBlankEspAsInctiveIfItHasNotBeenLoadedAndTheGameHasBeenInitialised) {
            Game game(Game::tes5);
            game.SetGamePath(dataPath.parent_path());
            ASSERT_NO_THROW(game.Init(false, localPath));
        ...
        TEST_F(GameTest, shouldShowBlankEsmAsInactiveIfItsHeaderHasBeenLoadedAndGameHasNotBeenInitialised) {
            Game game(Game::tes5);
            game.SetGamePath(dataPath.parent_path());
        ...
        TEST_F(GameTest, shouldShowBlankEspAsActiveIfItsHeaderHasBeenLoadedAndGameHasNotBeenInitialised) {
            Game game(Game::tes5);
            game.SetGamePath(dataPath.parent_path());
            ASSERT_NO_THROW(game.LoadPlugins(true));
        ...
        TEST_F(GameTest, shouldShowBlankEsmAsActiveIfItsHeaderHasBeenLoadedAndTheGameHasBeenInitialised) {
            Game game(Game::tes5);
            game.SetGamePath(dataPath.parent_path());
            ASSERT_NO_THROW(game.Init(false, localPath));
            ASSERT_NO_THROW(game.LoadPlugins(true));
        ...
        TEST_F(GameTest, shouldShowBlankEspAsActiveIfItsHeaderHasBeenLoadedAndTheGameHasBeenInitialised) {
            Game game(Game::tes5);
            game.SetGamePath(dataPath.parent_path());
            ASSERT_NO_THROW(game.Init(false, localPath));
            ASSERT_NO_THROW(game.LoadPlugins(true));
        ...
        TEST_F(GameTest, shouldShowBlankEsmAsActiveIfItHasBeenFullyLoadedAndTheGameHasBeenInitialised) {
            Game game(Game::tes5);
            game.SetGamePath(dataPath.parent_path());
            ASSERT_NO_THROW(game.Init(false, localPath));
            ASSERT_NO_THROW(game.LoadPlugins(false));
        ...
        TEST_F(GameTest, shouldShowBlankEspAsActiveIfItHasBeenFullyLoadedAndTheGameHasBeenInitialised) {
            Game game(Game::tes5);
            game.SetGamePath(dataPath.parent_path());
            ASSERT_NO_THROW(game.Init(false, localPath));
            ASSERT_NO_THROW(game.LoadPlugins(false));
