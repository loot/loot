...
#include "gui/query/types/copy_content_query.h"
#include "gui/query/types/copy_load_order_query.h"
#include "gui/query/types/copy_metadata_query.h"
#include "gui/query/types/discard_unapplied_changes_query.h"
#include "gui/query/types/editor_closed_query.h"
#include "gui/query/types/editor_opened_query.h"
#include "gui/query/types/get_auto_sort_query.h"
#include "gui/query/types/get_conflicting_plugins_query.h"
#include "gui/query/types/get_game_data_query.h"
#include "gui/query/types/get_game_types_query.h"
#include "gui/query/types/get_init_errors_query.h"
#include "gui/query/types/get_installed_games_query.h"
...
#include "gui/query/types/get_version_query.h"
#include "gui/query/types/open_log_location_query.h"
#include "gui/query/types/open_readme_query.h"
#include "gui/query/types/redate_plugins_query.h"
#include "gui/query/types/save_filter_state_query.h"
#include "gui/query/types/save_user_groups_query.h"
...
std::unique_ptr<Query> QueryHandler::createQuery(
  ...
  if (name == "applySort") {
    ...
    return std::make_unique<ClearAllMetadataQuery<>>(
        lootState_.GetCurrentGame(), lootState_.getLanguage());
  ...
  } else if (name == "getPreludeInfo") {
    return std::make_unique<GetPreludeInfoQuery>(lootState_.getPreludePath());
    ...
    return std::make_unique<UpdateMasterlistQuery<>>(
        lootState_.GetCurrentGame(), lootState_.getLanguage());
  } else if (name == "updatePrelude") {
    return std::make_unique<UpdatePreludeQuery>(
        lootState_.getPreludePath(),
        lootState_.getPreludeRepositoryURL(),
        lootState_.getPreludeRepositoryBranch());
